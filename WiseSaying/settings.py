"""
Django settings for WiseSaying project.
...
SECRET_KEY = 'django-insecure-xs%=p$wmpys4()q^7tdq(e!3d$_=)#hwh_b8l^z9&5&1!r%b1u'
...
WSGI_APPLICATION = 'WiseSaying.wsgi.application'
